# pycosa-toolbox [![Run tests](https://github.com/smba/pycosa-toolbox/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/smba/pycosa-toolbox/actions/workflows/tests.yml)
